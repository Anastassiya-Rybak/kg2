...
const changeClass = (el)=>{
    for(i = 0; i < tabs.children.length; i++)tabs.children[i].classList.remove("active");
...
tabs.addEventListener("click", (e)=>{
    ...
    for(let i1 = 0; i1 < content.length; i1++){
        content[i1].classList.add("d-none");
        if (content[i1].dataset.content === currTab) {
            content[i1].classList.remove("d-none");
            content[i1].classList.add("d-flex");
        }
    }
});
...
},{"./createPopper.js":"cHuNp","./modifiers/eventListeners.js":"hBKsL","./modifiers/popperOffsets.js":"6I679","./modifiers/computeStyles.js":"gDlm2","./modifiers/applyStyles.js":"4iMn4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["dyO8b","aitAD"], "aitAD", "parcelRequiread4d")
